...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
  ...
  public MyAdapter(
      ...
      Context context,
      Callback.OnItemClick clickListener) {
    this.roms = roms;
  ...
  public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    return new MyViewHolder(
        RomBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false),
        isDecompression,
        clickListener);
  }
  ...
  public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
    ...
    holder.binding.tvDelete.setText(
        currentRom.isDelete()
            ? context.getString(R.string.delete_true)
            : context.getString(R.string.delete_false));
  ...
  private void toggleCardClickable(MyViewHolder holder, Rom rom) {
      holder.binding.getRoot().setClickable(!rom.getStatus().equals(context.getString(R.string.status_added)) ? false : true);
      holder.binding.getRoot().setFocusable(!rom.getStatus().equals(context.getString(R.string.status_added)) ? false : true);
  }
  ...
  public static class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder(
        RomBinding binding, boolean isDecompression, Callback.OnItemClick clickListener) {
